...
def shared(sp):
    sp.add_argument(
        ...
        action=FullPaths,
        type=is_file,
        help="The file containing FASTA reads associated with targeted "
    ...
    sp.add_argument(
        ...
        type=float,
        default=0.65,
        help="The proportion of taxa required to have sequence at "
             "alignment ends."
    )
    sp.add_argument(
        "--threshold",
    ...
    sp.add_argument(
        ...
        type=float,
        default=0.20,
        help="The max proportion of sequence divergence allowed between any "
             "row of the alignment and the alignment consensus."
    )
    sp.add_argument(
        "--min-length",
        type=int,
