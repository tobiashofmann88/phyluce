...
def configure_parser(sub_parsers):
    ...
    sp.add_argument(
        ...
        action=FullPaths,
        type=is_file,
        help="The output file containing taxa and loci in "
             "complete/incomplete matrices generated by get_match_counts.py."
    )
    sp.add_argument(
        "--incomplete-matrix",
        action=FullPaths,
        default=False,
        help="The path to the outfile for incomplete-matrix records. "
    ...
    sp.add_argument(
        ...
        type=is_dir,
        action=FullPaths,
        help="A directory holding the assembled contigs (from genomes "
             "or another study) referenced by --extend-locus-db."
    )
